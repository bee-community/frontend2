...
import 'components/chat/ChatChat/drawer.css';
import ChatEndModal from 'components/chat/ChatEndModal/ChatEndModal';
import PointModal from 'components/chat/ChatList/PointModal';
...
const Chat = () => {
  ...
  const openViduSession = useSelector((store: any) => store.openViduSessionCheck);
