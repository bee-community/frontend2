...
import Title, { TitleContainerProps } from '@components/molecules/containers/TitleContainer';
...
function BestArticleList(props: BestArticleListProps) {
  return (
    <StyledBestArticleList>
      <Title title={props.title} subTitle={props.subTitle} navigate={props.navigate} />
